...
export const expertiseSections: ExpertiseSection[] = [
  {
    ...
    profiles: ['RSSI', 'RSSI de transition', 'Responsable cybersécurité', 'Chef de projet cybersécurité', 'Ingénieur cybersécurité', 'Expert sécurité', 'Auditeur sécurité', 'Consultant conformité'],
    missions: [
      ...
      { title: 'Plan d’actions et amélioration continue', description: 'Traduction des constats d’audit en plan d’actions priorisé, déploiement de solutions de protection, planification, cadrage budgétaire et suivi dans la durée.' },
      { title: 'Conseil, assistance et sensibilisation', description: 'Conseil stratégique et de gouvernance, assistance technique sur un périmètre défini, formation et sensibilisation des équipes aux bonnes pratiques.' },
    ],
