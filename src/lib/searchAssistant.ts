...
const DIRECT_INTENTS: Array<{ patterns: string[]; targetId: string }> = [
  ...
  { patterns: ['candidat', 'candidature', 'postuler', 'offre emploi', 'mission it', 'emploi it'], targetId: 'page-candidat' },
  { patterns: ['recrutement interne', 'carriere', 'carrières', 'rejoindre the porters'], targetId: 'page-recrutement' },
